                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('barang.index') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="barang_id" type="text" class="form-control @error('barang_id') is-invalid @enderror" name="barang_id" value="{{ old('barang_id') }}" required autocomplete="barang_id" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hargajual" type="text" class="form-control @error('hargajual') is-invalid @enderror" name="hargajual" required autocomplete="hargajual">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hargabeli" type="text" class="form-control @error('hargabeli') is-invalid @enderror" name="hargabeli" required autocomplete="hargabeli">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="satuan" type="text" class="form-control @error('satuan') is-invalid @enderror" name="satuan" required autocomplete="satuan">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="kategory" type="text" class="form-control @error('kategory') is-invalid @enderror" name="kategory" required autocomplete="new-kategory">
